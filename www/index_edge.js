    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid142", tween: [ "style", "${_page_1th}", "left", '-463px', { fromValue: '2px'}], position: 9000, duration: 1500, easing: "easeInOutQuart" },
                { id: "eid130", tween: [ "style", "${_page_2th}", "left", '23px', { fromValue: '480px'}], position: 9000, duration: 1500, easing: "easeInOutQuart" },
